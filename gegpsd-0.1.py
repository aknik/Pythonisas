...
while 1:
	...
	if line[0:6] == '$GPRMC':
		print line
		latitude_in = string.atof(datablock[3].replace(" ", ""))
		longitude_in = string.atof(datablock[5].replace(" ", ""))
		if datablock[8] == "":
			datablock[8] = "0";
		altitude = string.atof(datablock[8].replace(" ", ""))
		speed_in = string.atof(datablock[7].replace(" ", ""))
		heading = string.atof(datablock[8].replace(" ", ""))
